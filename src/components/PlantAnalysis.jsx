...
import { Upload, Loader2, Camera, AlertCircle, Leaf, Bug, Droplet, Sun, Settings } from 'lucide-react';
    ...
    const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${import.meta.env.VITE_GEMINI_API_KEY}`, {
      ...
      body: JSON.stringify({
        contents: [{
          parts: [
            {
              text: `Analyze this plant image and provide a comprehensive health assessment. Please structure your response as follows:
...
**Health Assessment:**
- Overall health status (Healthy/Moderate Issues/Severe Issues)
- Confidence level (%)

**Issues Detected:**
- Diseases (if any)
- Pest infestations (if any)
- Nutrient deficiencies (if any)
- Environmental stress (if any)
...
**Prevention Tips:**
- Best practices for this plant
- Environmental conditions
- Monitoring schedule

Please be specific and practical in your recommendations. If you're uncertain about any aspect, please mention the confidence level.`
            },
            {
              inline_data: {
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-green-100 mb-4">Plant Health Analysis</h1>
          <p className="text-green-200 text-lg">Upload a plant photo for AI-powered health assessment</p>
        </div>
        ...
        <div className="bg-green-900/40 rounded-lg p-6 mb-8 ring-1 ring-green-800/50">
          ...
          <div className="mt-4 text-center">
            <span className="text-green-300 text-sm">
              {apiProvider === 'gemini' ? 
                '✨ Gemini 1.5 Flash - Optimized for plant analysis' : 
          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-green-900/90 rounded-lg p-6 max-w-2xl w-full">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-green-100">Capture Plant Photo</h3>
                <button
                  onClick={stopCamera}
        ...
        <div className="bg-green-900/40 rounded-lg p-6 mb-8 ring-1 ring-green-800/50">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Upload Area */}
            <div>
              <h3 className="text-xl font-semibold text-green-100 mb-4">Upload Plant Image</h3>
              ...
              <div className="border-2 border-dashed border-green-800/50 rounded-lg p-8 text-center">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-green-200 mb-2">Upload or capture a plant photo</p>
        ...
        {analysisResult && (
          <div className="bg-green-900/40 rounded-lg p-6 ring-1 ring-green-800/50">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-2xl font-bold text-green-100">Analysis Results</h3>
            </div>
        ...
        <div className="mt-8 grid md:grid-cols-4 gap-4">
          <div className="bg-green-900/40 rounded-lg p-4 ring-1 ring-green-800/50 text-center">
            ...
            <h4 className="text-green-200 font-medium">Disease Detection</h4>
            <p className="text-green-300 text-sm">Identify plant diseases</p>
          </div>

          <div className="bg-green-900/40 rounded-lg p-4 ring-1 ring-green-800/50 text-center">
            <AlertCircle className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <h4 className="text-green-200 font-medium">Pest Analysis</h4>
            <p className="text-green-300 text-sm">Detect pest infestations</p>
          </div>

          <div className="bg-green-900/40 rounded-lg p-4 ring-1 ring-green-800/50 text-center">
            <Droplet className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <h4 className="text-green-200 font-medium">Nutrient Check</h4>
            <p className="text-green-300 text-sm">Assess nutrient levels</p>
          </div>

          <div className="bg-green-900/40 rounded-lg p-4 ring-1 ring-green-800/50 text-center">
            <Sun className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <h4 className="text-green-200 font-medium">Care Tips</h4>
            <p className="text-green-300 text-sm">Get treatment advice</p>
          </div>
        </div>
      </div>
    </div>
